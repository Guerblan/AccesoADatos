...
/*Esta clase representa un fichero.Guarda id,nombre,tamaño,extensión y autor
 * El id se va generando sólo con un cntador estático.
 */
public class File {
    private int id;
    ...
    /*
     * Cada vez que creo un fichero nuevo se le asigna un id único automáticamente
     */
    ...
    /* Los getters y los setters para acceder/modificar atributos */
    public int getId() {
        return id;
    }
    ...
    /* para representar en texto del fichero */
    @Override
